...
var nameReal = "",
    ...
    elBtnHide = document.getElementById("btnHide");
...
elBtnHide.addEventListener("click",fnHide,false);
elBtnReset.addEventListener("click",fnHide,false);//Clear all
}()); 
