...
(function () {
    ...
    function fnFight() {
        ...
        if (heroAll[randomHero].power() === villainAll[randomVillain].power()) {
            ...
            elDivCenterCol.innerHTML = "<h3>A tie!"+"<br/>"+ "Hero ----"+heroAll[randomHero].name +" Power: " + heroAll[randomHero].power()+" and "+"Villian ----"+villainAll[randomVillain].name + " Power: " + villainAll[randomVillain].power()+"</h3>";
            ...
            elDivCenterCol.innerHTML = "<h3>"+"Hero Wins!"+"<br/>"+"Hero ----"+ heroAll[randomHero].name +" Power: " + heroAll[randomHero].power()+" and "+"Villian ----"+villainAll[randomVillain].name + " Power: " + villainAll[randomVillain].power()+"</h3>";
            ...
            elDivCenterCol.innerHTML = "<h3>Hero Loses!"+"<br/>"+"Hero ----"+ heroAll[randomHero].name +" Power: " + heroAll[randomHero].power()+" and "+"Villain ----"+villainAll[randomVillain].name + " Power: " + villainAll[randomVillain].power()+"</h3>";
