...
(function() {
    ...
    function fnGo() {
        ...
        if((valInFirst !== "") && (valInLast !== "") && (valInDOB !== "")) {
            ...
            // "An" grammer needed for Droid Types of 0 and 1
            if((randomDroid === 0) || (randomDroid === 1)) {
                ...
                // "A" grammer needed for Droid Types 2, 3, 4, and 5
                // Display the Droid Type based on the Random Number
    ...
    function fnDroidNameGen(n1, n2, dob) {
        ...
        switch (no) {
            ...
            case 6:
                console.log("IG-86");
                myDroid = n1.slice(0, 2).toUpperCase() + "-" + "8"+no;
                break;
            
            case 7:
                console.log("RA-7");
                myDroid = n1.slice(0, 1).toUpperCase() + n2.slice(0,1).toUpperCase()+"-" + no;
                break;
    ...
    elBtnReset.addEventListener("click", fnReset, false);    
}());
